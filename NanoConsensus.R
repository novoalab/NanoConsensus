...
##EPINANO processing:
if (file.exists(args$Epinano_Sample) && (file.exists(args$Epinano_IVT))) {
...
if (file.exists(args$Nanopolish_Sample) && (file.exists(args$Nanopolish_IVT))) {
  ...
  nanopolish_data <- list(data.frame(Reference= character(), Position=integer(), Difference=double(), Feature=character()),data.frame(Reference= character(), Position=integer(), Difference=double(), Feature=character()))

}

##TOMBO processing:
if (file.exists(args$Tombo_Sample)) {
  ...
  tombo_data <- list(data.frame(Reference= character(), Position=integer(), Difference=double(), Feature=character()),data.frame(Reference= character(), Position=integer(), Difference=double(), Feature=character()))

}

##NANOCOMPORE processing:
if (file.exists(args$Nanocomp_Sample)) {
  ...
  nanocompore_data <- list(data.frame(Reference= character(), Position=integer(), Difference=double(), Feature=character()),data.frame(Reference= character(), Position=integer(), Difference=double(), Feature=character()))
