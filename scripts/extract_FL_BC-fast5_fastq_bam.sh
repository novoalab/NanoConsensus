...
### create a sample with known stoichiometry and a fixed population of modified reads across stoichiometries ###
################################################################################################################
...
head -n $num_readsModified ./../../$6 > list_reads_mod.txt
...
head -n $num_readsUnmodified ./../../$7 > list_reads_unmod.txt
