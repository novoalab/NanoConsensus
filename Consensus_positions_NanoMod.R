...
parser$add_argument("--FC_thr", default=4, type="double", 
                    help="Fold change threshold for all results [default %(default)]")
...
##EPINANO processing: 
epinano_data <- epinano_processing(args$Epinano_Sample, args$Epinano_IVT, args$Initial_position, args$Final_position, args$FC_thr)

##NANOPOLISH processing: 
nanopolish_data <- nanopolish_processing(args$Nanopolish_Sample, args$Nanopolish_IVT, args$Initial_position, args$Final_position, args$FC_thr)

##TOMBO processing: 
tombo_data <- tombo_processing(args$Tombo_Sample, args$thr_tombo_pos, args$thr_tombo_kmer, args$Initial_position, args$Final_position, args$FC_thr)

##NANOCOMPORE processing:
nanocompore_data <- nanocomp_processing(args$Nanocomp_Sample, args$nanocomp_metric, args$thr_nanocomp, args$Initial_position, args$Final_position, args$FC_thr)
...
analysis_significant_positions(list_significant, args$Fasta_file, args$Output_name)
